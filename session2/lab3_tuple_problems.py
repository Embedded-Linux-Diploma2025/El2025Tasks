...
def find_tuple_stats(numbers_tuple):
    ...
    """
    # Write your solution here
    thesum=sum(numbers_tuple)
    themax=max(numbers_tuple)
    themin=min(numbers_tuple)
    thelength=len(numbers_tuple)
   
    return (thesum,themax,themin,thelength)
